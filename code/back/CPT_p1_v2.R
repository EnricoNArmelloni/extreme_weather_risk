...
# DAG
net=read.net('~/ARMELLONI_SLU/RiskAnalysis/networks/paper/BN_p1_v2.net', debug = T)
...
bnlearn::write.net( '~/ARMELLONI_SLU/RiskAnalysis/networks/single_events/BN_p1_v2_learn_pt1.net', net)
