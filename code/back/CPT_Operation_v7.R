...
# DAG
net=read.net('~/ARMELLONI_SLU/RiskAnalysis/networks/single_events/type1_v7_general_simple.net', debug = T)
...
df.var[df.var$fishing_style=='industrial'&
...
bnlearn::write.net( '~/ARMELLONI_SLU/RiskAnalysis/networks/single_events/v7_general_simple_leanrt.net', net)
