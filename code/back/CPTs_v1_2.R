...
# examples
#examp.dist=data.frame(var=rtruncnorm(a=0,b=1,n=100, mean=0.8, sd=0.2))
#pl.example.1=ggplot(data=examp.dist)+
...
#  ylab('Frequency')
#ggsave(plot= pl.example.1,'~/ARMELLONI_SLU/RiskAnalysis/results/images/paper_support/exampl1.jpeg', width=10, height = 5, units='cm')
#
#get.cpt(data.frame(node=c('A','B', 'C'), 
#                   link.w=c(2,1,NA),
#                   states=c(3,3,3),
...
safety.cpt=answer.to.cpt(x.ans=safe.ans, dim.name='safety', dim.labs = c('no','minor','life'))
