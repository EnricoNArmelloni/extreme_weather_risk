...
net=read.net('data/networks/BEWARE_v2_learn_pt1.net', debug = T)
...
z.cpt=x.cpt[[1]]%>%
    ...
    arrange(desc(monetary_loss), desc(economic_importance))
...
bnlearn::write.net( 'data/networks/BEWARE_v2_learn_pt2.net', net)
