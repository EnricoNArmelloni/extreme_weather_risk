...
# DAG
net=read.net('data/networks/BN_p1_v2.net', debug = T)
...
df.var[df.var$management=='status_quo',]$Freq=c(0,1,0)
...
df.var[df.var$strategy!='not_relevant' & df.var$fishing_style=='coastal_salmon',]$Freq=c(0,0,1,0,0,0,0)
...
df.var[df.var$strategy!='not_relevant' & df.var$fishing_style=='coastal',]$Freq=c(0,0.7,0.2,0,0.1,0,0)
...
bnlearn::write.net( 'data/networks/BN_p1_v2_learn_pt1.net', net)
