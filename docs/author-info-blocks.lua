...
return {
  {
    Pandoc = function (doc)
      ...
      local new_blocks = List:new{}
      new_blocks:extend(create_equal_contributors_block(doc.meta.author, mark) or {})
      new_blocks:extend(create_affiliations_blocks(doc.meta.institute) or {})
      new_blocks:extend(create_correspondence_blocks(doc.meta.author, mark) or {})

      -- Insert BEFORE everything
      doc.blocks = new_blocks .. doc.blocks
